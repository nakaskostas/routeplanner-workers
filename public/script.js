        ...
        function getPdfStatsHtml() {
            ...
            return `
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; font-size: 16px;">
                    ...
                    <tr style="border-bottom: 1px solid #ccc;"><td style="padding: 8px; font-weight: bold;">Μήκος Ήπιας/Λοιπής Διαδρομής (≤5%):</td><td style="padding: 8px;">${nonSteepDistance}</td></tr>
                </table>
            `;
        }
        ...
        function renderMapStyleSwitcher() {
            ...
            const widgetHtml = `
                <div class="map-style-container ${wasVisible ? 'menu-visible' : ''}">
                    ${activeItemHtml}
                    <div class="map-style-menu glass-panel ml-2">
                        ${menuItemsHtml}
                    </div>
                </div>
            `;
